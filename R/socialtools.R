...
shareButton <- function(link,
  ...
  soc.each <- list(
    ...
    list(name = "blogger", color = "#3b5998", show = blogger, link = "https://www.blogger.com/blog-this.g?u=&n=&t="),
    list(name = "weibo", color = "#3b5998", show = weibo, link = "https://service.weibo.com/share/share.php?url=&title="),
